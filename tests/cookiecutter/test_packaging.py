...
from pyfoundry.cookiecutter import cookiecutter_template
...
@mock.patch("pyfoundry.cookiecutter.packaging.toml.load")
...
@mock.patch("pyfoundry.cookiecutter.packaging.cookiecutter")
@mock.patch("pyfoundry.cookiecutter.packaging.os.chdir")
@mock.patch("pyfoundry.cookiecutter.packaging.subprocess.run")
@mock.patch(
    "pyfoundry.cookiecutter.packaging.spawn.find_executable",
...
def test_init_success(mock_spawn, mock_run, mock_chdir, mock_cookiecutter):
    ...
    mock_cookiecutter.assert_called_once_with("gh:ghimiresunil/pyfoundry")
