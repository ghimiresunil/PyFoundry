...
- Easy deployment from the `main` branch
...
We have to execute quite a number of commands to generate the docs.
To make this process easier, let's create a `Makefile`.
...
4. Then:
   ...
   - Your docs should now be live at:
     ...
     **URL:** https://ghimiresunil.github.io/PyFoundry/
